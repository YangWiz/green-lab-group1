import time
import random
from quicksort_cy import quicksort_cy
...
def benchmark_quicksort(data_size, num_runs=10):
    """
    Benchmarks the Cython Quicksort algorithm using random arrays.
    ...
    quicksort_cy([random.random() for _ in range(int(data_size * 0.1))])
