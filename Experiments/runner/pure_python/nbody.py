...
def benchmark_nbody(N, num_runs=5, dt=0.01):
    ...
    return {
        "algorithm": "N-Body Step Update (O(N^2))",
        "N": N,
        "num_runs": num_runs,
        "avg_time_ms": avg_time_ms,
    }
